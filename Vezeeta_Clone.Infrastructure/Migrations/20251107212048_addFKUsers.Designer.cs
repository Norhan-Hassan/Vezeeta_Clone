...
namespace Vezeeta_Clone.Infrastructure.Migrations
{
    ...
    [Migration("20251107212048_addFKUsers")]
    partial class addFKUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vezeeta_Clone.Data.Entities.Admin", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Vezeeta_Clone.Data.Entities.Admin", b =>
                {
                    b.HasOne("Vezeeta_Clone.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Vezeeta_Clone.Data.Entities.Admin", "Id")
            ...
            modelBuilder.Entity("Vezeeta_Clone.Data.Entities.Doctor", b =>
                {
                    b.HasOne("Vezeeta_Clone.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Vezeeta_Clone.Data.Entities.Doctor", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Vezeeta_Clone.Data.Entities.Patient", b =>
                {
                    b.HasOne("Vezeeta_Clone.Data.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("Vezeeta_Clone.Data.Entities.Patient", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
