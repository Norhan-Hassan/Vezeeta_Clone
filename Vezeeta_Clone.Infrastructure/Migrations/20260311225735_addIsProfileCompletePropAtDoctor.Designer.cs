...
namespace Vezeeta_Clone.Infrastructure.Migrations
{
    ...
    [Migration("20260311225735_addIsProfileCompletePropAtDoctor")]
    partial class addIsProfileCompletePropAtDoctor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vezeeta_Clone.Data.Entities.Doctor", b =>
                {
                    ...
                    b.HasOne("Vezeeta_Clone.Data.Entities.Clinic", "Clinic")
                        .WithOne("Doctor")
                        .HasForeignKey("Vezeeta_Clone.Data.Entities.Doctor", "ClinicId")
                        .OnDelete(DeleteBehavior.Restrict);
