namespace Vezeeta_Clone.Core.Resources
{
    public class SharedResourcesKeys
    {
        ...
        public const string FailToUpdate = "FailToUpdate";
        ...
        public const string PassMatchConfirm = "PassMatchConfirm";
        public const string PasswordMinLength = "PasswordMinLength";
        public const string PasswordCriteria = "PasswordCriteria";
